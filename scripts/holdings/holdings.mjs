...
// 需要现金的变动类型
export const CASH_TYPES = new Set([ChangeType.BUY, ChangeType.RIGHTS_ISSUE]);
// 不改变总成本的变动（按比例调整股数与单价）
export const NON_COST_BASIS_CHANGING_TYPES = new Set([
  ChangeType.SELL,
 ...
 */
export function validateChange(change, ctx = {}) {
 ...
 */
export function computeFromChanges(changes) {
 ...
 */
export function queryChanges(changes, q = {}) {
  return [...changes]
 ...
 */
export function getHoldingAt(changes, ticker, date) {
  const hist = changes
