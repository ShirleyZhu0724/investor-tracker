...

  {
    ...
    portfolios: [
      ...
      },
      {
        ...
        holdings: [
          { name: "长江电力", ticker: "600900.SH", weight: "21.05%", w: 21.05, note: "金额 4,129,230 元；成本 25.09 元（较 7 月 26.656 元进一步下降，8 月持续做 T 降本）；盈亏比例 11.96%。仓位由 7 月 32.77% 大幅降至 21.05%。", source: "用户提供", date: "2026-08-31" },
          { name: "神火股份", ticker: "000933.SZ", weight: "14.36%", w: 14.36, note: "金额 2,816,700 元；成本 26.36 元；盈亏比例 4.27%。仓位由 7 月 11.81% 升至 14.36%。", source: "用户提供", date: "2026-08-31" },
          { name: "云铝股份", ticker: "000807.SZ", weight: "13.14%", w: 13.14, note: "金额 2,578,161 元；成本 20.56 元；盈亏比例 31.83%。仓位与 7 月 13.05% 基本持平。", source: "用户提供", date: "2026-08-31" },
          { name: "中煤能源 H", ticker: "01898.HK", weight: "10.42%", w: 10.42, note: "金额 2,044,770 元；成本 -3.05 港币（已实现负成本）；盈亏比例 0.00%。【A→H 切换】7 月底为中煤能源 A 11.23%，最新截图为 H。", source: "用户提供", date: "2026-08-31" },
          { name: "华能国际电力股份 H", ticker: "00902.HK", weight: "6.74%", w: 6.74, note: "金额 1,322,797 元；成本 3.91 港币；盈亏比例 35.15%。【A→H 切换】7 月底为华能国际 A 7.77%，最新截图为 H。", source: "用户提供", date: "2026-08-31" },
          { name: "陕西能源", ticker: "001286.SZ", weight: "4.88%", w: 4.88, note: "金额 957,000 元；成本 9.15 元；盈亏比例 4.55%。仓位由 7 月 5.98% 小幅回落。", source: "用户提供", date: "2026-08-31" },
          { name: "中孚实业", ticker: "600595.SH", weight: "3.82%", w: 3.82, note: "金额 748,800 元；成本 6.03 元；盈亏比例 3.54%。仓位由 7 月 1.33% 大幅提升至 3.82%。", source: "用户提供", date: "2026-08-31" },
          { name: "中国海洋石油 H", ticker: "00883.HK", weight: "3.33%", w: 3.33, note: "金额 652,824 元；成本 25.66 港币；盈亏比例 -0.94%。【A→H 切换】7 月底为中海油 A 3.12%，最新截图为 H。", source: "用户提供", date: "2026-08-31" },
          { name: "新城发展", ticker: "01030.HK", weight: "3.31%", w: 3.31, note: "金额 648,409 元；成本 0.78 港币；盈亏比例 65.47%。仓位与 7 月 3.68% 基本持平。", source: "用户提供", date: "2026-08-31" },
          { name: "宝丰能源", ticker: "600989.SH", weight: "1.76%", w: 1.76, note: "金额 346,080 元；成本 19.80 元；盈亏比例 24.88%。仓位与 7 月 1.80% 基本持平。", source: "用户提供", date: "2026-08-31" },
          { name: "陕西煤业", ticker: "601225.SH", weight: "1.24%", w: 1.24, note: "金额 243,056 元；成本 11.31 元；盈亏比例 144.12%。仓位由 7 月 3.34% 大幅降至 1.24%。", source: "用户提供", date: "2026-08-31" },
          { name: "腾讯控股", ticker: "00700.HK", weight: "0.60%", w: 0.60, note: "金额 118,521 元；成本 366.77 港币；盈亏比例 20.16%。仓位与 7 月 0.66% 基本持平。", source: "用户提供", date: "2026-08-31" },
