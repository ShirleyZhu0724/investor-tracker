...
window.PEOPLE = [
...

  {
    ...
    portfolios: [
      ...
      {
        date: "2026-08-10",
        label: "2026-08-10 · 股数快照（用户提供）",
        source: "用户提供",
        note: "用户提供的最新持股数（2026-08-10），仅含股数、无占比数据，故不参与百分比跨期对比；与 2026-07 游戏仓快照相比，中国神华H、兖矿能源、中国宏桥、中国石油化工、国电电力、中远海控、备用现金未在本次清单出现，系统按「清仓/退出」标记，实际是否仍持有请以鹿鼎公最新披露为准。",
        holdings: [
          { name: "长江电力", ticker: "600900.SH", weight: "147,000 股", w: null, note: "2026-08 做T：29.32 卖出、27.67 接回，波动降本（成本进一步下降）。", source: "用户提供", date: "2026-08-10" },
          { name: "云铝股份", ticker: "000807.SZ", weight: "85,000 股", w: null, note: "电解铝。", source: "用户提供", date: "2026-08-10" },
          { name: "神火股份", ticker: "000933.SZ", weight: "117,500 股", w: null, note: "电解铝。", source: "用户提供", date: "2026-08-10" },
          { name: "中煤能源", ticker: "601898.SH", weight: "195,000 股", w: null, note: "煤炭。", source: "用户提供", date: "2026-08-10" },
          { name: "华能国际", ticker: "600011.SH", weight: "280,000 股", w: null, note: "火电（华能国际电力股份）。", source: "用户提供", date: "2026-08-10" },
          { name: "陕西能源", ticker: "001286.SZ", weight: "120,000 股", w: null, note: "煤炭。", source: "用户提供", date: "2026-08-10" },
          { name: "新城发展", ticker: "01030.HK", weight: "550,000 股", w: null, note: "地产困境反转。", source: "用户提供", date: "2026-08-10" },
          { name: "陕西煤业", ticker: "601225.SH", weight: "8,800 股", w: null, note: "煤炭。", source: "用户提供", date: "2026-08-10" },
          { name: "中国海洋石油", ticker: "600938.SH", weight: "30,000 股", w: null, note: "油气（A股 600938 / H股 00883）。", source: "用户提供", date: "2026-08-10" },
          { name: "宝丰能源", ticker: "600989.SH", weight: "19,000 股", w: null, note: "煤化工。", source: "用户提供", date: "2026-08-10" },
          { name: "中孚实业", ticker: "600595.SH", weight: "120,000 股", w: null, note: "电解铝。", source: "用户提供", date: "2026-08-10" },
          { name: "腾讯控股", ticker: "00700.HK", weight: "300 股", w: null, note: "逆向弹性。", source: "用户提供", date: "2026-08-10" }
        ]
      }
    ],
    viewpoints: [
