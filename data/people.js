 ...
 *   - 跨期匹配以 ticker 优先（无 ticker 时回退 name）；这样不同数据源的名称差异
 *     （如「Apple Inc」vs「Apple Inc.」）不会造成假的「新建仓/清仓」。
 *
...
window.META = {
  ...
  note: "数据来自公开网络检索（2026-08-01）；2026-08-11 补充金渐成国际账户/精确占比/理念金句/人物画像 + 鹿鼎公 2026-08-10 股数快照（含长江电力做T）；2026-08-17 新增段永平 2026 Q2 13F（dataroma，18只/$19.1B，组合日2026-06-30）；同日新增伯克希尔·哈撒韦（dataroma 29只/$299B）与李录喜马拉雅资本（insiderset/SEC 13F 8只/$3.70B）两家，均含 2026 Q2 13F；2026-08-31 新增榆林子洲 2026年8月投资总结（公众号原文，11条含现金6.1%，当年收益9.5%；新买入腾讯5.8%/中创智领601717 5.2%，清仓第一太平，海油H由35%降至21%，青岛港H升至21.8%为第一大重仓）；仅供个人跟踪用途，非投资建议。"
};
...
window.PEOPLE = [
...

  {
    ...
    portfolios: [
      ...
      {
        date: "2026-08-31",
        label: "2026-08-31 · 公众号8月投资总结",
        source: "公众号",
        note: "当年收益9.5%（目标10%）；现金仓位提升至6.1%；前十大合计93.5%。来源：mp.weixin.qq.com/s/6ZGqzmSc22r4RGpnEwwiOQ",
        holdings: [
          { name: "青岛港 H", ticker: "06198.HK", weight: "21.8%", w: 21.8, note: "本月由11%大幅提升至21.8%，取代海油成为第一大重仓；上半年净利润同比持平，派息符合预期。作者列为三支「压舱石股票」之一。", source: "公众号", date: "2026-08-31" },
          { name: "中国海洋石油 H", ticker: "00883.HK", weight: "21%", w: 21, note: "本月由35%降低仓位至21%（主动减仓，非被动稀释）；二季度业绩符合预期、中报符合预期、三季度利润继续上升，估值处于合理状态。压舱石之一。", source: "公众号", date: "2026-08-31" },
          { name: "中国平安 A", ticker: "601318.SH", weight: "10.8%", w: 10.8, note: "沿用此前逻辑：营收恢复、非标下降、银保渠道利润率有保障；占比因组合整体变化小幅回落（7月12%）。", source: "公众号", date: "2026-08-31" },
          { name: "招商银行 A", ticker: "600036.SH", weight: "9.2%", w: 9.2, note: "沿用此前逻辑：股息率较高+低估值，有配置价值；占比小幅回落（7月10%）。", source: "公众号", date: "2026-08-31" },
          { name: "陕西煤业 A", ticker: "601225.SH", weight: "8.3%", w: 8.3, note: "二季度利润在四大煤企中应表现最好；近期煤价上升不改变其估值判断，已略为下调仓位（7月11%→8.3%）。压舱石之一。", source: "公众号", date: "2026-08-31" },
          { name: "天山铝业 A", ticker: "002532.SZ", weight: "6.6%", w: 6.6, note: "沿用此前逻辑：全产业链铝业，对比水铝成本更稳定；现金充沛，行业低谷期净利润率高。", source: "公众号", date: "2026-08-31" },
          { name: "现金", ticker: "", weight: "6.1%", w: 6.1, note: "作者明确披露「现金仓位提升至6.1%」，为8月主动提高的防御性仓位（7月未单独披露现金）。", source: "公众号", date: "2026-08-31" },
          { name: "腾讯控股", ticker: "00700.HK", weight: "5.8%", w: 5.8, note: "本月【新买入】。3月时曾为37.1%第一重仓，7月末已不在主要仓位，8月重新买入建仓5.8%；文章未展开具体买入理由。", source: "公众号", date: "2026-08-31" },
          { name: "中创智领 A", ticker: "601717.SH", weight: "5.2%", w: 5.2, note: "本月【新买入】。即原「郑煤机」（郑州煤矿机械集团），2025-07-15 起A股证券简称变更为中创智领，代码601717不变；主业为煤矿机械+汽车零部件（索恩格/亚新科）+工业智能。2026-08-31 收盘14.23元，总市值254亿，PE(动)7.92倍、PB 1.07倍（东方财富）。文章未展开具体买入理由。", source: "公众号", date: "2026-08-31" },
          { name: "美的集团 A", ticker: "000333.SZ", weight: "2.4%", w: 2.4, note: "沿用此前逻辑：中国最好家电企业，向智能化转型。", source: "公众号", date: "2026-08-31" },
          { name: "鄂资B", ticker: "900936.SH", weight: "2.4%", w: 2.4, note: "沿用此前逻辑：派息好、估值低、副产品多、成本可控，入股牛矿马泰壕；组合中股息率最高。", source: "公众号", date: "2026-08-31" }
        ]
      }
    ],
    viewpoints: [
      {
        date: "2026-08-31",
        content: "2026年8月投资总结：截至8月末当年收益9.5%，现金仓位提升至6.1%。今年最难的时候是6月30日，当年回撤8.2%，两个月时间反弹19.3%。今年目标收益10%，希望能实现。来源：mp.weixin.qq.com/s/6ZGqzmSc22r4RGpnEwwiOQ",
        source: "公众号",
        tags: ["月报", "收益", "回撤"]
      },
      {
        date: "2026-08-31",
        content: "压舱石股票三支：海油、陕煤、青岛港。海油二季度业绩符合预期、中报符合预期、三季度利润继续上升，估值处于合理状态；陕煤二季度利润在四大煤企中应表现最好，近期煤价上升不改变估值（已略为下调仓位）；青岛港上半年净利润同比持平、派息符合预期。",
        source: "公众号",
        tags: ["压舱石", "海油H", "陕煤", "青岛港"]
      },
      {
        date: "2026-08-31",
        content: "8月操作：降低海油仓位（35%→21%）、清仓第一太平（7月6%）、提升青岛港仓位（11%→21.8%）、新买入腾讯（5.8%）与中创智领（5.2%）。",
        source: "公众号",
        tags: ["操作", "调仓", "清仓"]
      },
      {
        date: "2026-08-31",
        content: "有一种预感，不一定准确：这几天的PVC、煤炭、烧碱有所上升，有一丢丢2021的感觉。（作者自述为预感，非结论）",
        source: "公众号",
        tags: ["周期", "宏观"]
      },
      {
        date: "2026-08-31",
        content: "股票市场是最差的也是最好的市场，短期奖励错误和运气，长期只会奖励有韧性的人，祝福所有坚守的朋友。",
        source: "公众号",
        tags: ["心态", "金句"]
      },
      {
    ...
    philosophy: {
      summary: "业余投资者，入市约15年。赚三份钱（股息、企业增长、市场波动）；主张“分散但集中”——主要仓位控制在3-4支深入研究的好公司，长期持有1-3年；控制回撤、用下跌调整组合；不熟不碰。2026年8月月报首次明确「压舱石股票」概念（海油/陕煤/青岛港三支），并主动把现金仓位提升至6.1%作防御；当年最大回撤出现在6月30日（-8.2%），两个月反弹19.3%，强调「长期只会奖励有韧性的人」。",
      points: [
        ...
        "设「压舱石股票」：海油/陕煤/青岛港三支扛波动",
        "现金也是仓位：主动提升现金比例作为防御工具"
      ],
      quotes: [
        "哪有必胜的股票，都是心魔罢了",
        "提高胜率就好，一切都是概率",
        ...
        "股票市场是最差的也是最好的市场，短期奖励错误和运气，长期只会奖励有韧性的人"
      ]
    }
  },
...
,
    {
      ...
      portfolios: [
        ...
        { date: "2025-03-31", label: "2025年Q1 · 13F（SEC EDGAR）", source: "SEC 13F",
          note: "组合价值约 $258.70B（权益多头，SEC 13F）。",
          holdings: [
            { name: "Apple Inc", ticker: "AAPL", weight: "25.76%", w: 25.76, shares: "", value: "$66,639,000,000", source: "SEC 13F", date: "2025-03-31", note: "" },
            { name: "American Express Co", ticker: "AXP", weight: "15.77%", w: 15.77, shares: "", value: "$40,790,858,835", source: "SEC 13F", date: "2025-03-31", note: "" },
            { name: "Coca Cola Co", ticker: "KO", weight: "11.07%", w: 11.07, shares: "", value: "$28,648,000,000", source: "SEC 13F", date: "2025-03-31", note: "" },
            { name: "Bank Amer Corp", ticker: "BAC", weight: "10.19%", w: 10.19, shares: "", value: "$26,355,563,449", source: "SEC 13F", date: "2025-03-31", note: "" },
            { name: "Chevron Corp New", ticker: "CVX", weight: "7.67%", w: 7.67, shares: "", value: "$19,842,356,232", source: "SEC 13F", date: "2025-03-31", note: "" },
            { name: "Occidental Pete Corp", ticker: "OXY", weight: "5.06%", w: 5.06, shares: "", value: "$13,077,509,034", source: "SEC 13F", date: "2025-03-31", note: "" },
            { name: "Moodys Corp", ticker: "MCO", weight: "4.44%", w: 4.44, shares: "", value: "$11,488,468,917", source: "SEC 13F", date: "2025-03-31", note: "" },
            { name: "Kraft Heinz Co", ticker: "KHC", weight: "3.83%", w: 3.83, shares: "", value: "$9,909,067,512", source: "SEC 13F", date: "2025-03-31", note: "" },
            { name: "Chubb Limited", ticker: "CB", weight: "3.16%", w: 3.16, shares: "", value: "$8,163,932,430", source: "SEC 13F", date: "2025-03-31", note: "" },
            { name: "Davita Inc", ticker: "DVA", weight: "2.08%", w: 2.08, shares: "", value: "$5,375,745,012", source: "SEC 13F", date: "2025-03-31", note: "" },
            { name: "Kroger Co", ticker: "KR", weight: "1.31%", w: 1.31, shares: "", value: "$3,384,499,999", source: "SEC 13F", date: "2025-03-31", note: "" },
            { name: "Verisign Inc", ticker: "VRSN", weight: "1.30%", w: 1.3, shares: "", value: "$3,373,901,836", source: "SEC 13F", date: "2025-03-31", note: "" },
            { name: "Visa Inc", ticker: "V", weight: "1.12%", w: 1.12, shares: "", value: "$2,907,927,832", source: "SEC 13F", date: "2025-03-31", note: "" },
            { name: "Sirius Xm Holdings Inc", ticker: "SIRI", weight: "1.04%", w: 1.04, shares: "", value: "$2,700,365,521", source: "SEC 13F", date: "2025-03-31", note: "" },
            { name: "Constellation Brands Inc", ticker: "STZ", weight: "0.85%", w: 0.85, shares: "", value: "$2,203,891,680", source: "SEC 13F", date: "2025-03-31", note: "" },
            { name: "Mastercard Inc", ticker: "MA", weight: "0.84%", w: 0.84, shares: "", value: "$2,185,161,502", source: "SEC 13F", date: "2025-03-31", note: "" },
            { name: "Amazon Com Inc", ticker: "AMZN", weight: "0.74%", w: 0.74, shares: "", value: "$1,902,600,000", source: "SEC 13F", date: "2025-03-31", note: "" },
            { name: "Aon Plc", ticker: "AON", weight: "0.63%", w: 0.63, shares: "", value: "$1,636,269,000", source: "SEC 13F", date: "2025-03-31", note: "" },
            { name: "Liberty Media Corp Del", ticker: "LSXMA", weight: "0.54%", w: 0.54, shares: "", value: "$1,395,342,717", source: "SEC 13F", date: "2025-03-31", note: "" },
            { name: "Capital One Finl Corp", ticker: "COF", weight: "0.50%", w: 0.5, shares: "", value: "$1,281,995,000", source: "SEC 13F", date: "2025-03-31", note: "" },
            { name: "Dominos Pizza Inc", ticker: "DPZ", weight: "0.47%", w: 0.47, shares: "", value: "$1,204,040,643", source: "SEC 13F", date: "2025-03-31", note: "" },
            { name: "Ally Finl Inc", ticker: "ALLY", weight: "0.41%", w: 0.41, shares: "", value: "$1,057,630,000", source: "SEC 13F", date: "2025-03-31", note: "" },
            { name: "T-Mobile Us Inc", ticker: "TMUS", weight: "0.40%", w: 0.4, shares: "", value: "$1,035,673,603", source: "SEC 13F", date: "2025-03-31", note: "" },
          ]
        },
        { date: "2025-06-30", label: "2025年Q2 · 13F（SEC EDGAR）", source: "SEC 13F",
          note: "组合价值约 $257.52B（权益多头，SEC 13F）。",
          holdings: [
            { name: "Apple Inc", ticker: "AAPL", weight: "22.31%", w: 22.31, shares: "", value: "$57,447,600,000", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "American Express Co", ticker: "AXP", weight: "18.78%", w: 18.78, shares: "", value: "$48,360,781,086", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Bank Amer Corp", ticker: "BAC", weight: "11.12%", w: 11.12, shares: "", value: "$28,641,252,185", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Coca Cola Co", ticker: "KO", weight: "10.99%", w: 10.99, shares: "", value: "$28,300,000,000", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Chevron Corp New", ticker: "CVX", weight: "6.79%", w: 6.79, shares: "", value: "$17,478,457,567", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Moodys Corp", ticker: "MCO", weight: "4.81%", w: 4.81, shares: "", value: "$12,374,113,948", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Occidental Pete Corp", ticker: "OXY", weight: "4.32%", w: 4.32, shares: "", value: "$11,130,189,516", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Kraft Heinz Co", ticker: "KHC", weight: "3.26%", w: 3.26, shares: "", value: "$8,407,891,001", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Chubb Limited", ticker: "CB", weight: "3.04%", w: 3.04, shares: "", value: "$7,832,227,900", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Davita Inc", ticker: "DVA", weight: "1.87%", w: 1.87, shares: "", value: "$4,814,317,266", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Verisign Inc", ticker: "VRSN", weight: "1.49%", w: 1.49, shares: "", value: "$3,838,117,344", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Kroger Co", ticker: "KR", weight: "1.39%", w: 1.39, shares: "", value: "$3,586,500,001", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Visa Inc", ticker: "V", weight: "1.14%", w: 1.14, shares: "", value: "$2,946,013,173", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Sirius Xm Holdings Inc", ticker: "SIRI", weight: "1.07%", w: 1.07, shares: "", value: "$2,751,270,614", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Mastercard Inc", ticker: "MA", weight: "0.87%", w: 0.87, shares: "", value: "$2,240,256,977", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Amazon Com Inc", ticker: "AMZN", weight: "0.85%", w: 0.85, shares: "", value: "$2,193,900,000", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Constellation Brands Inc", ticker: "STZ", weight: "0.85%", w: 0.85, shares: "", value: "$2,179,912,000", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Liberty Media Corp Del", ticker: "LSXMA", weight: "0.62%", w: 0.62, shares: "", value: "$1,597,850,379", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Unitedhealth Group Inc", ticker: "UNH", weight: "0.61%", w: 0.61, shares: "", value: "$1,572,192,781", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Capital One Finl Corp", ticker: "COF", weight: "0.59%", w: 0.59, shares: "", value: "$1,521,234,000", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Aon Plc", ticker: "AON", weight: "0.57%", w: 0.57, shares: "", value: "$1,462,716,000", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Dominos Pizza Inc", ticker: "DPZ", weight: "0.46%", w: 0.46, shares: "", value: "$1,186,820,921", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Ally Finl Inc", ticker: "ALLY", weight: "0.44%", w: 0.44, shares: "", value: "$1,129,550,000", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Pool Corp", ticker: "POOL", weight: "0.39%", w: 0.39, shares: "", value: "$1,008,195,800", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Nucor Corp", ticker: "", weight: "0.33%", w: 0.33, shares: "", value: "$856,792,068", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Lennar Corp", ticker: "LEN", weight: "0.31%", w: 0.31, shares: "", value: "$798,731,999", source: "SEC 13F", date: "2025-06-30", note: "" },
          ]
        },
        { date: "2025-09-30", label: "2025年Q3 · 13F（SEC EDGAR）", source: "SEC 13F",
          note: "组合价值约 $267.33B（权益多头，SEC 13F）。",
          holdings: [
            { name: "Apple Inc", ticker: "AAPL", weight: "22.69%", w: 22.69, shares: "", value: "$60,656,116,097", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "American Express Co", ticker: "AXP", weight: "18.84%", w: 18.84, shares: "", value: "$50,359,010,112", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Bank Amer Corp", ticker: "BAC", weight: "10.96%", w: 10.96, shares: "", value: "$29,306,731,919", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Coca Cola Co", ticker: "KO", weight: "9.92%", w: 9.92, shares: "", value: "$26,528,000,000", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Chevron Corp New", ticker: "CVX", weight: "7.09%", w: 7.09, shares: "", value: "$18,955,441,549", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Occidental Pete Corp", ticker: "OXY", weight: "4.68%", w: 4.68, shares: "", value: "$12,518,482,615", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Moodys Corp", ticker: "MCO", weight: "4.40%", w: 4.4, shares: "", value: "$11,754,655,821", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Chubb Limited", ticker: "CB", weight: "3.31%", w: 3.31, shares: "", value: "$8,843,709,614", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Kraft Heinz Co", ticker: "KHC", weight: "3.17%", w: 3.17, shares: "", value: "$8,479,530,661", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Alphabet Inc", ticker: "GOOGL", weight: "1.62%", w: 1.62, shares: "", value: "$4,338,397,121", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Davita Inc", ticker: "DVA", weight: "1.60%", w: 1.6, shares: "", value: "$4,273,176,132", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Kroger Co", ticker: "KR", weight: "1.26%", w: 1.26, shares: "", value: "$3,370,500,001", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Sirius Xm Holdings Inc", ticker: "SIRI", weight: "1.09%", w: 1.09, shares: "", value: "$2,904,885,649", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Visa Inc", ticker: "V", weight: "1.06%", w: 1.06, shares: "", value: "$2,832,586,895", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Verisign Inc", ticker: "VRSN", weight: "0.94%", w: 0.94, shares: "", value: "$2,513,300,752", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Mastercard Inc", ticker: "MA", weight: "0.85%", w: 0.85, shares: "", value: "$2,267,645,249", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Amazon Com Inc", ticker: "AMZN", weight: "0.82%", w: 0.82, shares: "", value: "$2,195,700,000", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Liberty Media Corp Del", ticker: "LSXMA", weight: "0.69%", w: 0.69, shares: "", value: "$1,844,208,905", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Constellation Brands Inc", ticker: "STZ", weight: "0.68%", w: 0.68, shares: "", value: "$1,804,578,000", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Unitedhealth Group Inc", ticker: "UNH", weight: "0.65%", w: 0.65, shares: "", value: "$1,740,161,449", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Capital One Finl Corp", ticker: "COF", weight: "0.57%", w: 0.57, shares: "", value: "$1,519,947,000", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Aon Plc", ticker: "AON", weight: "0.55%", w: 0.55, shares: "", value: "$1,461,978,000", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Dominos Pizza Inc", ticker: "DPZ", weight: "0.48%", w: 0.48, shares: "", value: "$1,287,335,476", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Ally Finl Inc", ticker: "ALLY", weight: "0.43%", w: 0.43, shares: "", value: "$1,136,800,000", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Pool Corp", ticker: "POOL", weight: "0.40%", w: 0.4, shares: "", value: "$1,072,496,472", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Lennar Corp", ticker: "LEN", weight: "0.34%", w: 0.34, shares: "", value: "$910,417,528", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Nucor Corp", ticker: "", weight: "0.32%", w: 0.32, shares: "", value: "$867,801,447", source: "SEC 13F", date: "2025-09-30", note: "" },
          ]
        },
        { date: "2025-12-31", label: "2025年Q4 · 13F（SEC EDGAR）", source: "SEC 13F",
          note: "组合价值约 $274.16B（权益多头，SEC 13F）。",
          holdings: [
            { name: "Apple Inc", ticker: "AAPL", weight: "22.60%", w: 22.6, shares: "", value: "$61,961,735,283", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "American Express Co", ticker: "AXP", weight: "20.46%", w: 20.46, shares: "", value: "$56,088,378,465", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "Bank America Corp", ticker: "BAC", weight: "10.38%", w: 10.38, shares: "", value: "$28,451,276,370", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "Coca Cola Co", ticker: "KO", weight: "10.20%", w: 10.2, shares: "", value: "$27,964,000,000", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "Chevron Corp New", ticker: "CVX", weight: "7.24%", w: 7.24, shares: "", value: "$19,837,131,131", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "Moodys Corp", ticker: "MCO", weight: "4.60%", w: 4.6, shares: "", value: "$12,602,556,092", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "Occidental Pete Corp", ticker: "OXY", weight: "3.97%", w: 3.97, shares: "", value: "$10,894,391,643", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "Chubb Limited", ticker: "CB", weight: "3.90%", w: 3.9, shares: "", value: "$10,689,854,998", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "Kraft Heinz Co", ticker: "KHC", weight: "2.88%", w: 2.88, shares: "", value: "$7,896,644,337", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "Alphabet Inc", ticker: "GOOGL", weight: "2.04%", w: 2.04, shares: "", value: "$5,585,842,446", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "Davita Inc", ticker: "DVA", weight: "1.32%", w: 1.32, shares: "", value: "$3,608,147,375", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "Kroger Co", ticker: "KR", weight: "1.14%", w: 1.14, shares: "", value: "$3,124,000,000", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "Visa Inc", ticker: "V", weight: "1.06%", w: 1.06, shares: "", value: "$2,910,002,197", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "Sirius Xm Holdings Inc", ticker: "SIRI", weight: "0.91%", w: 0.91, shares: "", value: "$2,495,518,305", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "Mastercard Incorporated", ticker: "MA", weight: "0.83%", w: 0.83, shares: "", value: "$2,275,897,610", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "Verisign Inc", ticker: "VRSN", weight: "0.80%", w: 0.8, shares: "", value: "$2,184,091,346", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "Constellation Brands Inc", ticker: "STZ", weight: "0.65%", w: 0.65, shares: "", value: "$1,793,480,000", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "Capital One Finl Corp", ticker: "COF", weight: "0.63%", w: 0.63, shares: "", value: "$1,732,874,000", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "Unitedhealth Group Inc", ticker: "UNH", weight: "0.61%", w: 0.61, shares: "", value: "$1,663,610,472", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "Dominos Pizza Inc", ticker: "DPZ", weight: "0.51%", w: 0.51, shares: "", value: "$1,396,347,000", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "Ally Finl Inc", ticker: "ALLY", weight: "0.48%", w: 0.48, shares: "", value: "$1,313,410,001", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "Liberty Live Holdings Inc", ticker: "LLYVA", weight: "0.48%", w: 0.48, shares: "", value: "$1,314,319,611", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "Aon Plc", ticker: "AON", weight: "0.46%", w: 0.46, shares: "", value: "$1,271,424,876", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "Nucor Corp", ticker: "", weight: "0.38%", w: 0.38, shares: "", value: "$1,045,167,939", source: "SEC 13F", date: "2025-12-31", note: "" },
          ]
        },
        { date: "2026-03-31", label: "2026年Q1 · 13F（SEC EDGAR）", source: "SEC 13F",
          note: "组合价值约 $263.10B（权益多头，SEC 13F）。",
          holdings: [
            { name: "Apple Inc", ticker: "AAPL", weight: "21.99%", w: 21.99, shares: "", value: "$57,843,260,493", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "American Express Co", ticker: "AXP", weight: "17.43%", w: 17.43, shares: "", value: "$45,859,204,536", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "Coca Cola Co", ticker: "KO", weight: "11.56%", w: 11.56, shares: "", value: "$30,420,000,000", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "Bank America Corp", ticker: "BAC", weight: "9.52%", w: 9.52, shares: "", value: "$25,039,178,044", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "Chevron Corporation", ticker: "CVX", weight: "6.64%", w: 6.64, shares: "", value: "$17,457,364,606", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "Occidental Pete Corp", ticker: "OXY", weight: "6.55%", w: 6.55, shares: "", value: "$17,221,193,015", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "Alphabet Inc", ticker: "GOOGL", weight: "6.32%", w: 6.32, shares: "", value: "$16,628,526,688", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "Chubb Ltd Switz", ticker: "CB", weight: "4.24%", w: 4.24, shares: "", value: "$11,162,836,215", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "Moodys Corp", ticker: "MCO", weight: "4.09%", w: 4.09, shares: "", value: "$10,762,190,653", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "Kraft Heinz Co", ticker: "KHC", weight: "2.78%", w: 2.78, shares: "", value: "$7,323,527,057", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "Davita Inc", ticker: "DVA", weight: "1.76%", w: 1.76, shares: "", value: "$4,626,158,909", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "Kroger Co", ticker: "KR", weight: "1.38%", w: 1.38, shares: "", value: "$3,618,000,000", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "Siriusxm Holdings Inc", ticker: "SIRI", weight: "1.09%", w: 1.09, shares: "", value: "$2,880,548,260", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "Delta Air Lines Inc", ticker: "", weight: "1.01%", w: 1.01, shares: "", value: "$2,646,532,635", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "Verisign Inc", ticker: "VRSN", weight: "0.85%", w: 0.85, shares: "", value: "$2,232,726,597", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "Liberty Live Holdings Inc", ticker: "LLYVA", weight: "0.55%", w: 0.55, shares: "", value: "$1,453,326,953", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "Capital One Finl Corp", ticker: "COF", weight: "0.50%", w: 0.5, shares: "", value: "$1,304,374,500", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "New York Times Co Mtn Be", ticker: "NYT", weight: "0.48%", w: 0.48, shares: "", value: "$1,268,219,376", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "Ally Finl Inc", ticker: "ALLY", weight: "0.43%", w: 0.43, shares: "", value: "$1,137,670,000", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "Lennar Corp", ticker: "LEN", weight: "0.34%", w: 0.34, shares: "", value: "$897,048,487", source: "SEC 13F", date: "2026-03-31", note: "" },
          ]
        },
        {
          date: "2026-06-30",
      ...
      viewpoints: [
        ...
        {
          date: "2026-08-17",
          content: "历史持仓已补充：2025 Q1–2026 Q1 共 5 期 13F（SEC EDGAR 官方库，权益多头）。可见苹果占比由 25.76% 降至 21.99%、谷歌（GOOGL）自 2025 Q3 新建仓并升至 2026 Q1 的 6.32%；美银、雪佛龙、西方石油长期稳居前五大。",
          source: "SEC 13F",
          tags: ["13F", "历史"]
        }
      ]
    }    ,
    {
      ...
      portfolios: [
        ...
        { date: "2025-03-31", label: "2025年Q1 · 13F（SEC EDGAR）", source: "SEC 13F",
          note: "组合价值约 $2.21B（权益多头，SEC 13F）。",
          holdings: [
            { name: "Alphabet Inc", ticker: "GOOGL", weight: "35.09%", w: 35.09, shares: "", value: "$776,262,511", source: "SEC 13F", date: "2025-03-31", note: "" },
            { name: "Bk Of America Corp", ticker: "BAC", weight: "26.12%", w: 26.12, shares: "", value: "$577,819,995", source: "SEC 13F", date: "2025-03-31", note: "" },
            { name: "Berkshire Hathaway Inc Del", ticker: "BRK.B", weight: "21.61%", w: 21.61, shares: "", value: "$478,123,162", source: "SEC 13F", date: "2025-03-31", note: "" },
            { name: "East West Bancorp Inc", ticker: "EWBC", weight: "11.26%", w: 11.26, shares: "", value: "$249,205,266", source: "SEC 13F", date: "2025-03-31", note: "" },
            { name: "Occidental Pete Corp", ticker: "OXY", weight: "3.27%", w: 3.27, shares: "", value: "$72,386,440", source: "SEC 13F", date: "2025-03-31", note: "" },
            { name: "Sable Offshore Corp", ticker: "SBLE", weight: "1.54%", w: 1.54, shares: "", value: "$34,071,910", source: "SEC 13F", date: "2025-03-31", note: "" },
            { name: "Apple Inc", ticker: "AAPL", weight: "1.11%", w: 1.11, shares: "", value: "$24,567,578", source: "SEC 13F", date: "2025-03-31", note: "" },
          ]
        },
        { date: "2025-06-30", label: "2025年Q2 · 13F（SEC EDGAR）", source: "SEC 13F",
          note: "组合价值约 $2.69B（权益多头，SEC 13F）。",
          holdings: [
            { name: "Alphabet Inc", ticker: "GOOGL", weight: "32.84%", w: 32.84, shares: "", value: "$883,041,866", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Bk Of America Corp", ticker: "BAC", weight: "18.36%", w: 18.36, shares: "", value: "$493,613,233", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Pdd Holdings Inc", ticker: "PDD", weight: "17.93%", w: 17.93, shares: "", value: "$482,273,280", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Berkshire Hathaway Inc Del", ticker: "BRK.B", weight: "16.22%", w: 16.22, shares: "", value: "$436,099,532", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "East West Bancorp Inc", ticker: "EWBC", weight: "10.43%", w: 10.43, shares: "", value: "$280,355,924", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Occidental Pete Corp", ticker: "OXY", weight: "2.29%", w: 2.29, shares: "", value: "$61,607,665", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Sable Offshore Corp", ticker: "SBLE", weight: "1.10%", w: 1.1, shares: "", value: "$29,519,140", source: "SEC 13F", date: "2025-06-30", note: "" },
            { name: "Apple Inc", ticker: "AAPL", weight: "0.84%", w: 0.84, shares: "", value: "$22,691,802", source: "SEC 13F", date: "2025-06-30", note: "" },
          ]
        },
        { date: "2025-09-30", label: "2025年Q3 · 13F（SEC EDGAR）", source: "SEC 13F",
          note: "组合价值约 $3.23B（权益多头，SEC 13F）。",
          holdings: [
            { name: "Alphabet Inc", ticker: "GOOGL", weight: "37.62%", w: 37.62, shares: "", value: "$1,215,290,345", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Pdd Holdings Inc", ticker: "PDD", weight: "18.85%", w: 18.85, shares: "", value: "$609,039,360", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Bk Of America Corp", ticker: "BAC", weight: "16.66%", w: 16.66, shares: "", value: "$538,155,255", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Berkshire Hathaway Inc Del", ticker: "BRK.B", weight: "13.97%", w: 13.97, shares: "", value: "$451,334,332", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "East West Bancorp Inc", ticker: "EWBC", weight: "9.15%", w: 9.15, shares: "", value: "$295,542,564", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Occidental Pete Corp", ticker: "OXY", weight: "2.15%", w: 2.15, shares: "", value: "$69,292,125", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Apple Inc", ticker: "AAPL", weight: "0.87%", w: 0.87, shares: "", value: "$28,162,078", source: "SEC 13F", date: "2025-09-30", note: "" },
            { name: "Sable Offshore Corp", ticker: "SBLE", weight: "0.73%", w: 0.73, shares: "", value: "$23,448,780", source: "SEC 13F", date: "2025-09-30", note: "" },
          ]
        },
        { date: "2025-12-31", label: "2025年Q4 · 13F（SEC EDGAR）", source: "SEC 13F",
          note: "组合价值约 $3.57B（权益多头，SEC 13F）。",
          holdings: [
            { name: "Alphabet Inc", ticker: "GOOGL", weight: "43.86%", w: 43.86, shares: "", value: "$1,565,270,840", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "Bk Of America Corp", ticker: "BAC", weight: "16.08%", w: 16.08, shares: "", value: "$573,726,285", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "Pdd Holdings Inc", ticker: "PDD", weight: "14.64%", w: 14.64, shares: "", value: "$522,501,120", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "Berkshire Hathaway Inc Del", ticker: "BRK.B", weight: "12.64%", w: 12.64, shares: "", value: "$451,253,535", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "East West Bancorp Inc", ticker: "EWBC", weight: "8.74%", w: 8.74, shares: "", value: "$312,034,089", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "Occidental Pete Corp", ticker: "OXY", weight: "1.69%", w: 1.69, shares: "", value: "$60,302,480", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "Crocs Inc", ticker: "CROX", weight: "1.51%", w: 1.51, shares: "", value: "$53,720,158", source: "SEC 13F", date: "2025-12-31", note: "" },
            { name: "Apple Inc", ticker: "AAPL", weight: "0.84%", w: 0.84, shares: "", value: "$30,067,716", source: "SEC 13F", date: "2025-12-31", note: "" },
          ]
        },
        { date: "2026-03-31", label: "2026年Q1 · 13F（SEC EDGAR）", source: "SEC 13F",
          note: "组合价值约 $3.20B（权益多头，SEC 13F）。",
          holdings: [
            { name: "Alphabet Inc", ticker: "GOOGL", weight: "44.81%", w: 44.81, shares: "", value: "$1,434,531,266", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "Pdd Holdings Inc", ticker: "PDD", weight: "14.71%", w: 14.71, shares: "", value: "$470,845,440", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "Berkshire Hathaway Inc Del", ticker: "BRK.B", weight: "13.44%", w: 13.44, shares: "", value: "$430,201,321", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "East West Bancorp Inc", ticker: "EWBC", weight: "9.26%", w: 9.26, shares: "", value: "$296,403,233", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "Bk Of America Corp", ticker: "BAC", weight: "4.57%", w: 4.57, shares: "", value: "$146,151,866", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "Occidental Pete Corp", ticker: "OXY", weight: "2.98%", w: 2.98, shares: "", value: "$95,322,500", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "Crocs Inc", ticker: "CROX", weight: "2.30%", w: 2.3, shares: "", value: "$73,646,461", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "Tencent Music Entmt Group", ticker: "TME", weight: "1.91%", w: 1.91, shares: "", value: "$61,162,958", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "Block H & R Inc", ticker: "XYZ", weight: "1.61%", w: 1.61, shares: "", value: "$51,637,996", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "Moodys Corp", ticker: "MCO", weight: "1.61%", w: 1.61, shares: "", value: "$51,383,270", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "S&P Global Inc", ticker: "SPGI", weight: "1.61%", w: 1.61, shares: "", value: "$51,663,072", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "Apple Inc", ticker: "AAPL", weight: "0.88%", w: 0.88, shares: "", value: "$28,069,174", source: "SEC 13F", date: "2026-03-31", note: "" },
            { name: "Msci Inc", ticker: "MSCI", weight: "0.32%", w: 0.32, shares: "", value: "$10,208,310", source: "SEC 13F", date: "2026-03-31", note: "" },
          ]
        },
        {
          date: "2026-06-30",
      ...
      viewpoints: [
        ...
        {
          date: "2026-08-17",
          content: "历史持仓已补充：2025 Q1–2026 Q1 共 5 期 13F（SEC EDGAR 官方库，权益多头）。组合极度集中：谷歌（GOOGL）由 35.09% 升至 44.81%、拼多多稳定 14–18%、伯克希尔B 12–22%；美银占比由 26% 降至 4.57%（2026 Q1 大幅减仓）。",
          source: "SEC 13F",
          tags: ["13F", "历史"]
        }
      ]
